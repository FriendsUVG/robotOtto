...
const int distanciaMaxima = 20; // Distancia máxima en centímetros para detectar un obstáculo
...
void loop() {
  ...
  // // Si la distancia es menor que la distancia máxima, detener el robot
